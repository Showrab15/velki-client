...
// export default function SuperAgentThirdTable() {


//     const [agents, setAgents] = useState([]);

//     useEffect(() => {
//       fetch("superagentsthirdtable.json")
//         .then((res) => res.json())
...
//     সাব এডমিন 13 এর অধীনে সর্বমোট সুপার এজেন্ট আছে 28 জন    </h3>
...
export default function SuperAgentThirdTable() {
  ...
  return (
    <div>
      ...
      সাব এডমিন 13 এর অধীনে সর্বমোট সুপার এজেন্ট আছে 28 জন
      </h4>
...
<div className="p-4">
  <table className="w-full table-auto border-collapse border border-gray-300">
    ...
    <tbody>
      {SuperAgent.slice(15,43).map((agent, rowIndex) => (
        <tr
          key={agent.id}
