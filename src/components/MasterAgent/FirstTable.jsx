    ...
    <table className="table-fixed border-collapse border border-gray-300 w-full">
      <thead>
        <tr>
          ...
          <th className="border border-gray-400 px-2 py-2 bg-[#fff6f3] text-xs sm:text-sm md:text-base w-[10%]">APP</th>
          <th className="border border-gray-400 px-2 py-2 bg-[#fff6f3] text-xs sm:text-sm md:text-base w-[35%]">PHONE NUMBER</th>
          <th className="border border-gray-400 px-2 py-2 bg-[#fff6f3] sm:text-center text-left text-xs sm:text-sm md:text-base w-[24%]">COMPLAIN</th>
        </tr>
      </thead>
      <tbody>
