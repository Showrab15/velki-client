...
export default function MasterAgentBanner() {
  return (
    <div className="mt-10 mx-4 md:mx-10">
      ...
      <div>
        <h3 className="mb-4 text-lg font-semibold text-left text-black">
          এজেন্ট দের সাথে লেনদেন এর আগে ভেল্কির নিয়ম গুলো জেনে নিন!!
        </h3>
        <p className=" w-full md:text-[14px] text-xs  font-semibold leading-8 text-left">
          ...
          **হোয়াটসঅ্যাপ ব্যাতিত অন্য কোন এপ এর মাধ্যমে যোগাযোগ বা লেনদেন করা
          ...
          কোন ইউজার যদি এজেন্ট কে টাকা পাঠায় – অই টাকার দায়ভার ভেল্কি নিবে না।
